...
parser.add_argument('--target', type=str, default='50m', help='target feature')
...
parser.add_argument('--seq_len', type=int, default=800, help='input sequence length of resnet')
parser.add_argument('--label_len', type=int, default=600, help='start token length of Informer decoder')
parser.add_argument('--pred_len', type=int, default=800, help='prediction sequence length, horizon')
...
parser.add_argument('--input_channel', type=int, default=800, help='dim of input, the same as n_channel')
parser.add_argument('--stride', type=int, default=2, help='stride of kernel moving')
parser.add_argument('--base_filter', type=int, default=2, help='number of filters in the first several Conv layer, it will double at every 4 layers')
parser.add_argument('--groups', default=1, type=int, help='set largest to 1')
parser.add_argument('--n_block', default=21, type=int, help='number of blocks')
parser.add_argument('--kernel', default=6, type=int, help='width of kernel')
parser.add_argument('--n_classes', default=800, type=int, help='number of classes')
